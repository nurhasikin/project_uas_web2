<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="datatransaksi.aspx.vb" Inherits="hypermart.datatransaksi" %>
                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                     ...
                     <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="active-menu" href="datatransaksi.aspx"><i class="fa fa-shopping-cart"></i> Data Penjualan</a>
                            </li>
                                <li>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <asp:GridView cssClass="table table-striped table-bordered table-hover" ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="kdtrans" DataSourceID="SqlDataSource1">
                                    <Columns>
                                        <asp:BoundField DataField="kdtrans" HeaderText="kdtrans" ReadOnly="True" SortExpression="kdtrans" />
                                        <asp:BoundField DataField="kdplg" HeaderText="kdplg" SortExpression="kdplg" />
                                        <asp:BoundField DataField="tgl" HeaderText="tgl" SortExpression="tgl" />
                                        <asp:BoundField DataField="bayar" HeaderText="bayar" SortExpression="bayar" />
                                        <asp:BoundField DataField="kembali" HeaderText="kembali" SortExpression="kembali" />
                                    </Columns>
                                </asp:GridView>
                               
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:hypermartConnectionString2  %>" DeleteCommand="DELETE FROM [ttrans] WHERE [kdtrans] = @kdtrans" InsertCommand="INSERT INTO [ttrans] ([kdtrans], [kdplg], [tgl], [bayar], [kembali]) VALUES (@kdtrans, @kdplg, @tgl, @bayar, @kembali)" SelectCommand="SELECT * FROM [ttrans]" UpdateCommand="UPDATE [ttrans] SET [kdplg] = @kdplg, [tgl] = @tgl, [bayar] = @bayar, [kembali] = @kembali WHERE [kdtrans] = @kdtrans">
                                    <DeleteParameters>
                                        <asp:Parameter Name="kdtrans" Type="String" />
                                    </DeleteParameters>
                                    <InsertParameters>
                                        <asp:Parameter Name="kdtrans" Type="String" />
                                        <asp:Parameter Name="kdplg" Type="String" />
                                        <asp:Parameter Name="tgl" Type="String" />
                                        <asp:Parameter Name="bayar" Type="Double" />
                                        <asp:Parameter Name="kembali" Type="Double" />
                                    </InsertParameters>
                                    <UpdateParameters>
                                        <asp:Parameter Name="kdplg" Type="String" />
                                        <asp:Parameter Name="tgl" Type="String" />
